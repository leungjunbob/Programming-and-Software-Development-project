/**
 * This is the truck class extends from vehicle, it has the same private variable as described in vehicle class and
...
public class Truck extends Vehicle{
     ...
     */
    public Truck(String vehicleType, String rengId, String model, String colour, Date entryDate) {
    ...
    public double calculateParkingFee(Date timeOfExit) {
        final int hourParkingFee = 10;
        final int overnightFee = 20;
        final int hitFine = 50;
