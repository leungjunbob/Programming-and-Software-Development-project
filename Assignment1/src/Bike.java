...
public class Bike {
    ...
    public Bike(String rengId, String model, String colour, int hour, int minute, boolean parking) {
        this.rengId = rengId;
        this.model = model;
        this.colour = colour;
        this.hour = hour;
    ...
    // Edit the current row or current column of the bike,
    ...
    public void setCurrentPosition(int[] position) {
        ...
        // If bike did an invalid movement, use this function return it to the position before.
    }
    ...
    public float getTotalParkingFee() {
        this.totalParkingFee = totalHour * 2 + totalNumberOfHit * 10;
